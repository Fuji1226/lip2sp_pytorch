...
def make_model(
    ...
    model = Lip2SP_NAR(
        ...
        cfg.model.res_inner_channels,
        cfg.model.which_res,
        cfg.model.rnn_n_layers,
        cfg.model.rnn_which_norm,
        cfg.model.trans_enc_n_layers,
        cfg.model.trans_enc_n_head,
        cfg.model.trans_pos_max_len,
        cfg.model.conf_n_layers,
        cfg.model.conf_n_head,
        cfg.model.audio_dec_conf_feedforward_expansion_factor,
        cfg.model.dec_n_layers,
        cfg.model.dec_kernel_size,
        cfg.model.n_speaker,
        cfg.model.spk_emb_dim,
        cfg.model.which_encoder,
        cfg.model.which_decoder,
        cfg.model.where_spk_emb,
        cfg.model.use_spk_emb,
        cfg.model.dec_dropout,
        cfg.model.res_dropout,
        cfg.model.audio_enc_rnn_dropout,
        cfg.model.is_large,
        cfg.model.adversarial_learning,
        cfg.model.reduction_factor,
    )
