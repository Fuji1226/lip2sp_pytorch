...
from model.vq_vae import VQVAE_Redu2_AR_Post
...
def train_one_epoch(model, train_loader, optimizer, loss_f, device, cfg, training_method, mixing_prob, epoch, ckpt_time, scheduler):
    ...
    for batch in train_loader:
        ...
        loss = output_loss + vq_loss + ctc_loss + stop_token_loss + dec_output_loss
        loss.backward()
...
def main(cfg):
    ...
    with wandb.init(**cfg.wandb_conf.setup, config=wandb_cfg, settings=wandb.Settings(start_method='fork')) as run:
        ...
        tts_path = '/home/naoaki/lip2sp_pytorch_all/lip2sp_920_re/check_point/taco/noramaldata/mspec80_430.ckpt'
        model = load_vqvae_decoder_from_taco(model, tts_path)
