...
from model.tts_taco import JVSTacotron
...
from synthesis_tts import generate_for_jvs
...
def train_one_epoch(model, train_loader, optimizer, loss_f, device, cfg):
    ...
    for batch in train_loader:
        ...
        dec_output, output, logit, att_w = model(text, text_len, xvector, feature_target=feature)
