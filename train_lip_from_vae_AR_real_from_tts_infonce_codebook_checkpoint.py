...
from model.lip_from_vae import Lip2Sp_VQVAE_TacoAR_InfoNCE, Lip_VQENC
...
def make_model(cfg, device):
    model = Lip2Sp_VQVAE_TacoAR_InfoNCE(
    )
...
def train_one_epoch(model, ref_model, train_loader, optimizer, loss_f, device, cfg, training_method, mixing_prob, epoch, ckpt_time, scheduler):
    ...
    for batch in train_loader:
        ...
        with torch.autograd.set_detect_anomaly(True):
            ...
            all_output = model(lip, data_len, feature=feature, mode='train', reference=ref, encoding_indices=encoding_indices, code_book=code_book)
            ...
            infoNCE_loss = all_output['infoNCE_codebook_loss']
    ...
    sum_loss['epoch_infoNCE_loss'] /= grad_cnt
    return sum_loss
...
def main(cfg):
    ...
    with wandb.init(**cfg.wandb_conf.setup, config=wandb_cfg, settings=wandb.Settings(start_method='fork')) as run:
        ...
        num_warmup_steps =int(len(train_loader)/cfg.train.gradient_accumulation_steps) * 3

        num_training_steps = int(len(train_loader)/cfg.train.gradient_accumulation_steps) * (GRAD_OK_EPOCH + 20)
        ...
        checkpoint_path = '/home/naoaki/lip2sp_pytorch_all/lip2sp_920_re/check_point/lip_from_vae_tts_3000_codebook/mspec80_70.ckpt'
        ...
        for epoch in range(cfg.train.max_epoch - last_epoch):
            ...
            train_infoNCE_loss_list.append(train_sum_loss['epoch_infoNCE_loss'])
            ...
            val_infoNCE_loss_list.append(val_sum_loss['epoch_infoNCE_loss'])
