...
def train_one_epoch(model, train_loader, train_dataset, optimizer, loss_f, device, cfg, ckpt_time):
    ...
    for batch in train_loader:
        ...
        dec_feat_output, dec_lip_output, feat_output, lip_output, logit, att_w_enc_list, att_w_dec_self_list, att_w_dec_enc_list = \
            model(text, text_len, lip_len, feature, lip, spk_emb=spk_emb)
