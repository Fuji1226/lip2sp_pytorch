...
def generate(cfg, model, test_loader, dataset, device, save_path, ref_loader):
    ...
    for batch in tqdm(test_loader, total=len(test_loader)):
        ...
        with torch.no_grad():
            output, feat_add_out, phoneme, spk_emb, mu, logvar, z, enc_output = model.forward_(feature=feature, feat_add=feat_add, feature_ref=feature_ref, data_len=data_len)
...
def main(cfg):
    ...
    # model_path = Path("/home/usr4/r70264c/lip2sp_pytorch/check_point/vae/lip/2022:09:09_08-38-34/mspec80_200.ckpt") 
    model_path = Path("/home/usr4/r70264c/lip2sp_pytorch/check_point/vae/lip/2022:09:09_09-27-38/mspec80_200.ckpt") 
