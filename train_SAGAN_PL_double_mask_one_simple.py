...
def main(cfg):
    ...
    D_PL = Discriminator_suvey_simple2(stride=2, PL=False)
    ...
    with wandb.init(**cfg.wandb_conf.setup, config=wandb_cfg, settings=wandb.Settings(start_method='fork')) as run:
        ...
        train_SAGAN_loop(1000, model, D_simple, D_PL, train_loader, optimizer, optimizer_d_simple, optimizer_d_PL, loss_f=loss_f, save_path=save_path, device=device, training_method='ss', mixing_prob=mixing_prob, cfg=cfg, test_loader=test_loader, test_dataset=test_dataset, ckpt_path=ckpt_path)
