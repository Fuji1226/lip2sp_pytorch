...
from model.tts_taco import TTSTacotronVqRe
...
def train_one_epoch(model, train_loader, optimizer, loss_f, device, cfg):
    ...
    for batch in train_loader:
        ...
        dec_output, output, logit, att_w, vq_loss, perplexity = model(text, text_len, feature_target=feature)
    ...
    return epoch_loss, epoch_output_loss, epoch_dec_output_loss, epoch_stop_token_loss, epoch_vq_loss
...
def main(cfg):
    ...
    train_loader, val_loader, train_dataset, val_dataset = make_train_val_loader_tts_final(cfg, data_root)
    ...
    for epoch in range(cfg.train.max_epoch - last_epoch):
        ...
        epoch_loss, epoch_output_loss, epoch_dec_output_loss, epoch_stop_token_loss, epoch_vq_loss = train_one_epoch(
            model=model,
        ...
        epoch_loss, epoch_output_loss, epoch_dec_output_loss, epoch_stop_token_loss, epoch_vq_loss = val_one_epoch(
            model=model,
