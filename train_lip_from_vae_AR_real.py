...
from model.lip_from_vae import Lip2Sp_VQVAE_TacoAR
...
def train_one_epoch(model, train_loader, optimizer, loss_f, device, cfg, training_method, mixing_prob, epoch, ckpt_time, scheduler):
    ...
    for batch in train_loader:
        ...
        all_output = model(lip, data_len, feature=feature, mode='train')
...
def main(cfg):
    ...
    with wandb.init(**cfg.wandb_conf.setup, config=wandb_cfg, settings=wandb.Settings(start_method='fork')) as run:
        ...
        vq_path = '/home/naoaki/lip2sp_pytorch_all/lip2sp_920_re/check_point/vq_vae/VAEAR/mspec80_200.ckpt'
        model = load_from_vqvae_ctc(model, vq_path)
