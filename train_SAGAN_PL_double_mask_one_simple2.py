...
from model.SAGAN.simple2d import Discriminator, train_SAGAN_PFmask_simple_epoch
...
def train_SAGAN_loop(epochs, G, D_simple, D_PL, train_loader, opt_G, opt_D_simple, opt_D_PL, loss_f, save_path, device, training_method, mixing_prob, cfg, test_loader, test_dataset, ckpt_path):
    ...
    for epoch in range(epochs): 
        ...
        if epoch < 100:
            ...
            train = True
        loss_D_all, corret_cnt, wrong_cnt, change_g_PL, change_d_PL = train_SAGAN_PFmask_simple_epoch(G, D_PL, opt_D_PL, opt_G, train_loader, training_method, mixing_prob, loss_f, device, change_g_PL, change_d_PL, epoch)
