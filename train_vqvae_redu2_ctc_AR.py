...
from model.vq_vae import VQVAE_Redu2_AR
...
@hydra.main(config_name="config_vqvae_AR", config_path="conf")
def main(cfg):
    if cfg.train.debug:
    ...
    with wandb.init(**cfg.wandb_conf.setup, config=wandb_cfg, settings=wandb.Settings(start_method='fork')) as run:
        ...
        # path = '/home/naoaki/lip2sp_pytorch_all/lip2sp_920_re/check_point/vq_vae/mspec80_80.ckpt'
